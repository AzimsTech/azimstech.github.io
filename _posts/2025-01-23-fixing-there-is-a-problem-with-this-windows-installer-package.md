...
2. `Next`  
  ![img1](troubleshooter1.png){: w="450" h="450" .shadow }
3. Choose `Uninstalling`  
  ![img2](troubleshooter2.png){: w="450" h="450" .shadow }
4. Select Program you want to uninstall --> `Next`  
  ![img3](troubleshooter3.png){: w="450" h="450" .shadow }
5. `Yes, try uninstall`  
  ![img4](troubleshooter4.png){: w="450" h="450" .shadow }
6. Check if the program is uninstalled, if its working, its done you can close it.  
  ![img5](troubleshooter5.png){: w="450" h="450" .shadow }
